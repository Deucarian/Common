# Deucarian Common Agent Notes

Package ID: `com.deucarian.common`
Repository: `Deucarian/Common`
...
- Logging, editor UI, JSON, networking, diagnostics, state, UI, domain helpers, or generic utility-bucket APIs.

## Dependencies

Allowed dependency shape:

- No package dependencies. Common must stay lowest-level and runtime-only.
...
- Logging: No Logging dependency and no logging facade ownership.
- Common: This package is the Common boundary. Do not add APIs without audit evidence.
- Editor UI: No editor UI/chrome/resources.
- Diagnostics: No diagnostics providers, export, UI, or telemetry.
- Testing: Keep tests focused on the public Common API; test fixture teardown may use direct Unity teardown.
